-- Fixed Sample Data with proper IDs
...
-- 2. Insert Clients
INSERT INTO "Client" (id, name, email, phone, company, address, notes, status, "userId", "createdAt", "updatedAt") VALUES
...
-- 3. Insert Projects
INSERT INTO "Project" (id, name, description, status, "startDate", "endDate", budget, "hourlyRate", "userId", "clientId", "createdAt", "updatedAt") VALUES
...
-- 4. Insert Tasks
INSERT INTO "Task" (id, title, description, status, priority, "dueDate", "estimatedHours", "actualHours", "userId", "projectId", "createdAt", "updatedAt") VALUES
...
-- 5. Insert Invoices
INSERT INTO "Invoice" (id, number, status, "issueDate", "dueDate", subtotal, tax, total, notes, "paidAt", "userId", "clientId", "projectId", "createdAt", "updatedAt") VALUES
...
INSERT INTO "InvoiceItem" (id, description, quantity, rate, amount, "invoiceId") VALUES
...
INSERT INTO "Communication" (id, type, subject, content, "sentAt", "clientId", "createdAt") VALUES
...
-- 8. Insert Notes
INSERT INTO "Note" (id, title, content, tags, "userId", "createdAt", "updatedAt") VALUES
